...
public class MainActivity extends AppCompatActivity {
    ...
    final String LIFECYCLE_CALLBACKS_TEXT_KEY = "LIFECYCLE_CALLBACKS_TEXT_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                String previousLicecycleCallbaks =
                        savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(previousLicecycleCallbaks);
            }
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String currentCallbacks = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, currentCallbacks);
