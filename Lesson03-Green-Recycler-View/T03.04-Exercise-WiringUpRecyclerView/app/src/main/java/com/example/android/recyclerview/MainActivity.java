...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView mNubmersList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNubmersList = (RecyclerView) findViewById(R.id.rv_numbers);
        ...
        mNubmersList.setAdapter(mAdapter);
    }
}
